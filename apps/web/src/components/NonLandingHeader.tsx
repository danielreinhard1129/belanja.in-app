...
const NonLandingHeader: FC<{ label: string }> = ({ label }) => {
  ...
  return (
    <div className="fixed top-0 z-50 w-full flex h-16 items-center justify-start gap-4 border-b-4 bg-gradient-to-b from-white from-70% to-gray-50 bg-white px-4">
      <div
